...
?>
    ...
    <div id="content-wrapper">
      ...
      <div class="mui-container-fluid">
		...
		<div class="ipeka">
		<div id="ekloginbaslikred"><img src="images/kkaldir.png" alt="ekle" /></div>
		<form name="yonsil" action="func/ysil.php" method="GET" id="eklogin">
		<fieldset>
				<p><label for="text" style="font-size:150%;">Kullanıcı Adı:</label></p>
				<p><input type="text" name="sil" required /></p>
				<p><input type="submit" style="background-color: #EF5350;" value="Yönetici Hesabını Sil"></p>
				</form>
		</fieldset>				
		</div>
