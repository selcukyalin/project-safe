...
?>
    ...
    <div id="content-wrapper">
      ...
      <div class="mui-container-fluid">
		...
		<form name="stsil" action="func/nsil.php" method="GET" id="eklogin">
		<fieldset>
				<p><label for="text" style="font-size:150%;">Kullanıcı Adı:</label></p>
				<p><input type="text" name="siln" required /></p>
				<p><input type="submit" style="background-color: #EF5350;" value="Standart Hesabı Sil"></p>
				</form>
		</fieldset>				
		</div>
