...
?>
    ...
    <div id="content-wrapper">
      ...
      <div class="mui-container-fluid">
		...
		<form name="yonek" action="func/yonekle.php" method="POST" id="eklogin">
		<fieldset>
				<p><label for="text" style="font-size:150%;">İsim ve Soyisim:</label></p>
				<p><input type="text" name="adsoyad" required /></p>
				...
				<p><input type="text" name="yonkadi" required /></p>
				<p><label for="text" style="font-size:150%;">Şifre:</label></p>
				<p><input type="password" name="yonsifre" required /></p>
				<p><input type="submit" value="Yönetici Hesabını Oluştur"></p>
				</form>
		</fieldset>				
		</div>
