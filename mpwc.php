...
?>
    ...
    <div id="content-wrapper">
      ...
      <div class="mui-container-fluid">
		...
		<div class="ipeka">
		<div id="ekloginbaslikgreen"><img src="images/pwc.png" alt="şifre değiştir" /></div>
		<form name="mpwc" action="func/mpwcf.php" method="POST" id="eklogin">
		<fieldset>
				<p><label for="text" style="font-size:150%;">Kullanıcı Adı:</label></p>
				<p><input type="text" name="ckad" required /></p>
				<p><label for="text" style="font-size:150%;">Yeni Şifre:</label></p>
				<p><input type="password" name="mnpw" required /></p>
				<p><input type="submit" value="Şifresini Değiştir"></p>
				</form>
		</fieldset>				
		</div>
