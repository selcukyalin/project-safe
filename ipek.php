...
?>
    ...
    <div id="content-wrapper">
      ...
      <div class="mui-container-fluid">
		...
		<div class="ipeka">
		<div id="ekloginbaslikgreen"><img src="images/ipekle.png" alt="ekle" /></div>
		<form name="ipekle" action="func/ipekle.php" method="POST" id="eklogin">
		<fieldset>
				<p><label for="text" style="font-size:150%;">IP Adresi:</label></p>
				<p><input type="text" name="ipe" required /></p>
				<p><input type="submit" value="IP Adresini Ekle"></p>
				</form>
				<form name="selfip" action="func/selfip.php" id="eklogin" method="POST">
				<input type="submit" value="Kendi IP Adresini Kaydet">
				</form>
		</fieldset>				
		</div>
