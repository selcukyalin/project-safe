...
?>
    ...
    <div id="content-wrapper">
      ...
      <div class="mui-container-fluid">
        <br />
		<div class="ipeka">
		<div id="ekloginbaslikred"><img src="images/ipkaldir.png" alt="kaldir" /></div>
		<form name="ipsil" action="func/ipsil.php" id="eklogin" method="GET">
			<fieldset>
				<p><label for="text" style="font-size:150%;">IP Adresi:</label></p>
				<p><input type="text" name="ipk" required /></p>
				<p><input type="submit" style="background-color: #EF5350;" value="IP Adresini Sil"></p>
				</form>
					<form name="tumsil" action="func/tumsil.php" id="eklogin" method="POST" onsubmit="return confirm('Kayıtlı tüm IP adreslerini silmek istediğinizden emin misiniz?');">
					<input type="submit" style="background-color: #EF5350;" value="Tüm IP Adreslerini Sil!">
					</form>
			</fieldset>
		</div>
