...
?>
    ...
    <div id="content-wrapper">
      ...
      <div class="mui-container-fluid">
	  <h1 class="baslik">Kayıtlı Yönetici Hesapları <i style="font-size: 75%;" onclick="yenile()" class="fa fa-refresh" aria-hidden="true"></i></h1><br />
<table style='width:65%;'>
<th>Kullanıcı Adı</th> <th>İsim</th> <th>Kayıt Tarihi</th> <th>Sil</th>
	<?php
$dir = "users/mod/";
chdir($dir);
...
foreach($files as $filename) {
	...
	echo "<tr><td>".substr($filename, 0, -4)."</td><td>$isim</td><td>$tarih</td><td><a href='func/ysil.php?sil=".substr($filename, 0, -4)."'><img src='images/sil.png' style='padding-top:5px; padding-bottom:5px;' /></a></td></tr>";
}
	?>
</table>
</div>
